              ...
              <tbody>
                ...
                while($d_siswa = mysqli_fetch_array($siswa)){
                  ...
                  <tr>
                    ...
                    <td><?=$d_siswa['nis']?></td>
                    <td><?=$d_siswa['nama']?></td>
                    <td><?=$d_siswa['nama_kelas']?> <?=$d_siswa['kompetensi_keakhlian']?></td>
                        ...
                        <div class="modal-body">
                          <form method="post" action="update_siswa.php">
                            <div class="form-group">
                              <label>NISN</label>
                              <input type="text" name="nisn" class="form-control" value="<?php echo $d_siswa['nisn']; ?>" placeholder="Masukan NISN" readonly>
                            </div>
                            <div class="form-group">
                              <label>NIS</label>
                            ...
                            <div class="form-group">
                              ...
                              <select name="id_kelas" class="form-control">
                                ...
                                while($d_kelas = mysqli_fetch_array($kelas)){
                                  ?>
                                  <option value="<?=$d_kelas['id_kelas']?>" <?php if($d_kelas['id_kelas'] == $d_siswa['id_kelas']){ echo 'selected'; } ?>><?=$d_kelas['nama_kelas']?> <?=$d_kelas['kompetensi_keakhlian']?></option>
                                <?php } ?>
                              </select>
                            </div>
                            <div class="form-group">
